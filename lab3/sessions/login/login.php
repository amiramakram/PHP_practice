...
<div class="container">
    <div class="row">
      <div class="d-flex justify-content-center" ><p class="fs-1 " style="color: navy; font-weight: bolder;">Login</p></div>
<form method="post" action="validateLogin.php" enctype="multipart/form-data">
  ...
  <button type="submit" class="btn" style="background-color: rgb(68, 108, 91);color: aliceblue; border-bottom:3px rgb(157, 172, 158) solid">Login</button>
</div>
</form>
</div>
</div>